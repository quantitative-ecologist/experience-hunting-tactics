...
Individual variation in predator foraging behaviour is increasingly recognized as a major driver of trophic interactions and community dynamics [@Griffen.etal2012;@Michalko.Pekar2016;@Moran.etal2017;@Michalko.etal2021]. Indeed, predator populations often comprise assemblages of individuals using different foraging tactics to hunt their prey, with consequences for habitat use, functional responses, prey choice, and foraging rate [@Kobler.etal2009;@toscanoTraitmediatedFunctionalResponses2014;@Patrick.Weimerskirch2014;@Matsumura.Miyatake2022a]. Theory suggests that foraging tactics are learned through repeated interactions with prey, and the capacity of predators to effectively use them should be contingent on periods of extensive practice, i.e., experience [@toscanoPersonalityForagingBehavior2016;@DeLisle.etal2022;@Tinker.etal2009;@Dukas2019]. Predators often hunt using techniques that are fine-tuned to the type of prey that they encounter, and their refinement is crucial for young predators to reach adulthood and survive [@Estes.etal2003;@Woo.etal2008;@Phillips.etal2017;@Heithaus.etal2018;@Courbin.etal2018]. For example, predatory blue acaras (*Andinoacara pulcher*) adjust their maximum approach speed through repeated exposures to prey with different escape patterns [@Szopa-Comley.Ioannou2022]. However, the mechanisms underlying how individuals respond to experience, as well as their consequences, remain unclear, hindering our ability to predict the behavioural decisions and the success of predators when they are hunting.

Empirical studies on human and non-human hunters show that individuals optimize foraging efficiency (e.g. search and handling times, return rates) via associative images or reliance on prey and environmental cues [@Edwards.Jackson1994;@Morse2000;@MacDonald2007;@Reid.etal2010;@Wilson-Rankin2015]. Through this process, predators with extensive practice acquire expertise (e.g. skills, knowledge) that allows them to outperform novice hunters [@Dukas2019]. In light of this work, it has been suggested that experience may lead to individual foraging specialization (e.g. repeatedly using fast attacks) if a predator consistently increases its prey capture by using the same tactic through time [@Tinker.etal2009;@Dukas2019]. Yet, an alternative view is that learning operates as a mechanism driving behavioural flexibility. For instance, predators gain experience and information on their prey as they hunt in varying habitats, and may thus hunt optimally by adjusting their behaviour to the type of prey that they encounter [@Stephens1993;@Ishii.Shimada2010;@Mery.Burns2010;@Kelley.Magurran2011;@Snell-Rood2013]. To develop proper responses to fluctuating resources, individuals would need to sample their environment broadly during an extensive period, leading to greater performance at later stages of development [reviewed in @Snell-Rood2013]. Context-dependence has proven to be key in defining how individual predators learn to hunt, making it challenging to predict under which circumstances they should specialize in their foraging with experience.
