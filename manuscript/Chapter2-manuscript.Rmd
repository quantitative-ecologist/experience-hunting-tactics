...
At all experience levels, predators that were on average faster were also travelling faster in all their matches ($cor_{novice}$ = `r toString(format(cor_tab[1,2]))` [`r toString(format(cor_tab[1,3]))`, `r toString(format(cor_tab[1,4]))`], $cor_{interm}$ = `r toString(format(cor_tab[6,2]))` [`r toString(format(cor_tab[6,3]))`, `r toString(format(cor_tab[6,4]))`], $cor_{adv}$ = `r toString(format(cor_tab[15,2]))` [`r toString(format(cor_tab[15,3]))`, `r toString(format(cor_tab[15,4]))`]) (i.e. they were more specialized at travelling fast). Thus, slower predators were also more flexible in their movement through time (Figure 4). This pattern became stronger as predators gained experience (Figure 4). In general, predators tended to be faster when they encountered prey that were on average faster ($cor_{novice}$, $cor_{interm}$, $cor_{adv}$) (Figure 4). They were also more specialized at being fast when prey were on average faster (Figure 4).

Moreover, predators favored and specialized in a faster foraging mode when encounters with prey were more predictable, and these relationships also became stronger with experience (Figure 4).
