...
tab1 <-
  ...
  # Table caption
  set_caption(
    caption = "Table S1. Posterior medians and 95% HDP intervals of the fixed effects estimated by the MDHGLM of predator speed, prey speed, and predator hunting success.",
    style = "Table Caption"
  ) %>%
