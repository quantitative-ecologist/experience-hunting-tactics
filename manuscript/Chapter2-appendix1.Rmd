...
output: 
  word_document:
    reference_docx: Chapter2-styles-appendix.docx
    fig_caption: yes
...
Authors : Maxime Fraser Franco, Francesca Santostefano, Julien G. A. Martin, Clint D. Kelly, Pierre-Olivier Montiglio
...
b_draws[
  , c("b_sigma_speednovice_Intercept",
      ...
      "b_sigma_speednovice_sqrt_prey_avg_rank",
      "b_sigma_speedinterm_sqrt_prey_avg_rank",
      "b_sigma_speedadvanced_sqrt_prey_avg_rank",
      "b_sigma_preyspeednovice_sqrt_prey_avg_rank",
      "b_sigma_preyspeedinterm_sqrt_prey_avg_rank",
      "b_sigma_preyspeedadvanced_sqrt_prey_avg_rank"
  )
...
b_draws[
  , c("b_successnovice_Intercept",
      ...
      "b_successnovice_sqrt_game_duration",
      "b_successinterm_sqrt_game_duration",
      "b_successadvanced_sqrt_game_duration"
  )
...
table <- fixef_tab[c(3, 5, 4, 6, 7, 9, 8, 10, 1, 2)]
...
tab1 <-
  ...
  # Table caption
  set_caption(
    caption = "Table S1. Posterior medians and 95% credible intervals of the fixed effects estimated by the MDHGLM of predator speed, prey speed, and predator hunting success.",
    style = "Table Caption"
  ) %>%
...
tab2 <-
  ...
  footnote(
    ...
    value = as_paragraph(
      ...
      as_sup("\nc "),
      "Values on the dispersion (i.e. sigma) for predator speed indicate among individual differences in behavioural specialization. For prey speed, they indicate among individual differences in the variability of prey encounters."
    ),
    ref_symbols = " "
  ) %>%
  ...
  # Add table caption
  set_caption(
    caption = "Table S2. Posterior medians and 95% credible intervals of the random effects estimated by the MDHGLM of predator speed, prey speed, and predator hunting success. All the reported values are standard deviations.",
    style = "Table Caption"
  ) %>%
...
```{r figS1, out.width = "100%", fig.cap = "**Figure S1.** Among individual differences in the development of hunting expertise. The predators' hunting success (i.e. the probability of capturing the four prey) is on the y axis, and the predators' cumulative experience (i.e. the number of matches played prior to each observation) is on the x axis. Each fitted curve represents an individual predator. (A) Individuals with a >0.5 change in hunting success with experience (B) Individuals with a <-0.5 change in hunting success with experience. (C) Individuals with a change in hunting success between -0.5 and 0.5"}
...
```{r figS2, out.width = "100%", fig.cap = "**Figure S2.** Correlations between the predators' mean hunting success and intra individual variance in speed indicating differences in success between specialist and flexible hunters. Individuals with lower IIV are specialist hunters, while individuals with higher IIV are flexible hunters. (A) Correlation when predators were novice (B) Correlation when predators were advanced"}
