...
```{r figS4, out.width = "80%", fig.cap = "**Figure S4.** Posterior median differences and 95% credible intervals in the correlations of players when they were advanced vs novice. The difference is displayed on the x axis and the parameter correlations are displayed on the y axis."}
