...
tab2 <-
  ...
  # Table caption
  set_caption(
    caption = "Table S1. Posterior means and 95% credible intervals of the fixed effects estimated by the MDHGLM of predator speed, prey speed, and predator hunting success. The coefficients are from the model that includes the outlier.",
    style = "Table Caption"
  ) %>%
...
tab3 <-
  ...
  # Add table caption
  set_caption(
    caption = "Table S2. Posterior means and 95% credible intervals of the random effects estimated by the MDHGLM of predator speed, prey speed, and predator hunting success. The coefficients are from the model that includes the outlier.",
    style = "Table Caption"
  ) %>%
