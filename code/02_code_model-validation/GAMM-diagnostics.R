...
# Posterior predictive checks -------------------------------------------
 ...
 # Check distributions
 pp1 <- pp_check(mod1)
 pp1 <- pp1 + ggtitle("GAMM - A1") +
  theme(legend.position = "bottom")
 pp2 <- pp_check(mod2)
 pp2 <- pp2 + ggtitle("GAMM - A2") +
  theme(legend.position = "bottom")
 pp3 <- pp_check(mod3)
 pp3 <- pp3 + ggtitle("GAMM - A3") +
  theme(legend.position = "bottom")
 pp4 <- pp_check(mod4)
 pp4 <- pp4 + ggtitle("GAMM - A2 prey") +
  theme(legend.position = "bottom")
 pp5 <- pp_check(mod5)
 pp5 <- pp5 + ggtitle("GAMM - A3 prey") +
  theme(legend.position = "bottom")

 # Effects plot (mean variance plot)
 stat1 <- pp_check(mod1, type = "stat_2d")
 stat1 <- stat1 + ggtitle("GAMM - A1") +
  theme(legend.position = "bottom")
 stat2 <- pp_check(mod2, type = "stat_2d")
 stat2 <- stat2 + ggtitle("GAMM - A2") +
  theme(legend.position = "bottom")
 stat3 <- pp_check(mod3, type = "stat_2d")
 stat3 <- stat3 + ggtitle("GAMM - A3") +
  theme(legend.position = "bottom")
 stat4 <- pp_check(mod4, type = "stat_2d")
 stat4 <- stat4 + ggtitle("GAMM - A2 prey") +
  theme(legend.position = "bottom")
 stat5 <- pp_check(mod5, type = "stat_2d")
 stat5 <- stat5 + ggtitle("GAMM - A3 prey") +
  theme(legend.position = "bottom")
