...
cor_matrix_novice <- cbind(speed, latency, prey_avg_speed, prey_var_speed)
rownames(cor_matrix_novice) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
colnames(cor_matrix_novice) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
...
cor_matrix_interm <- cbind(speed, latency, prey_avg_speed, prey_var_speed)
rownames(cor_matrix_interm) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
colnames(cor_matrix_interm) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
...
cor_matrix_advanced <- cbind(speed, latency, prey_avg_speed, prey_var_speed)
rownames(cor_matrix_advanced) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
colnames(cor_matrix_advanced) <- c("speed", "latency", "avg. prey speed", "var. prey speed")
...
corrplot(cor_matrix_novice, type = "lower", method = "ellipse", 
                        ...
                        tl.cex = 1.5, tl.srt = 45, number.digits = 3,
                        addCoef.col = "black", 
                        col = RColorBrewer::brewer.pal(n = 10, name = "RdBu"), 
                        mar = c(0,0,0,0))
graph2ppt(file = "./figures/trait-correlations3a.pptx", 
          width = 10, height = 6)
