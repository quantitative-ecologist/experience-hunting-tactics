...
#         GAMM model GS - group-level smoother - latency 1st capture
...
# Load data ----------------------------------------------------------------
 ...
 # Round latency and code as integer
 data[, latency_1st_capture := as.integer(round(latency_1st_capture))]
